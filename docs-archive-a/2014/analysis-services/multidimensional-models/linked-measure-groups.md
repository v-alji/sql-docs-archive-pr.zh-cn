...
# <a name="linked-measure-groups"></a>链接度量值组
 ...
 Microsoft 建议原始和链接度量值组驻留于在同一台服务器上运行的解决方案中。 在将来的版本中，将计划在远程服务器上链接到度量值组， (参阅[SQL Server 2014) 中的弃用 Analysis Services 功能](../deprecated-analysis-services-features-in-sql-server-2014.md)。  
