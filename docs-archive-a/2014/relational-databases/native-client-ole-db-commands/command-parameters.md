...
> [!NOTE]  
>  为了 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (UDT) 公开对 XML 和用户定义类型的支持， [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 提供程序实现新的[ISSCommandWithParameters](../native-client-ole-db-interfaces/isscommandwithparameters-ole-db.md)接口。  
