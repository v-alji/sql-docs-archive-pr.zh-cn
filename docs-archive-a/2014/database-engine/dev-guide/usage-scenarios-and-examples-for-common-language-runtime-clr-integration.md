...
|[使用 CLR 处理大型对象](../../../2014/database-engine/dev-guide/handling-large-objects-using-clr.md)|演示如何使用 CLR 存储过程将大型二进制对象传输 (Lob) [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 与服务器可访问的文件系统之间。|  
