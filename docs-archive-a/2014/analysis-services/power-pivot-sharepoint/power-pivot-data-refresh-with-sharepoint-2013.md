 ...
 ** (\*) **有关工作簿升级的详细信息，请参阅[&#40;SharePoint 2013&#41;升级工作簿和计划的数据刷新](../instances/install-windows/upgrade-workbooks-and-scheduled-data-refresh-sharepoint-2013.md)。  
...
1.  在 SharePoint 文档库中，为 PowerPivot 工作簿单击 "**打开" 菜单** (") **"。**  
