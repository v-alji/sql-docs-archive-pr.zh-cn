...
2.  单击第二行中的单元格 (**SalesDate**列中的列标题行) 下，并拖动以选择包含的所有单元格 `[Sum(Sales)]` 。  
...
##  <a name="6-optional-format-data-as-dates"></a><a name="FormatDates"></a>6. (可选) 将数据设置为日期格式  
