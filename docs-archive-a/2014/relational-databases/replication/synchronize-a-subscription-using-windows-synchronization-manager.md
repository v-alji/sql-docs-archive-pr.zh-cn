...
1.  在“订阅属性 - \<Subscriber>: \<SubscriptionDatabase>”对话框中，启用使用 Windows 同步管理器对请求订阅进行同步的选项。 有关访问此对话框的详细信息，请参阅[查看和修改请求订阅属性](view-and-modify-pull-subscription-properties.md)。  
...
1.  使用下列方法之一启动同步管理器：  
    ...
    -   单击 **“开始”** ，再单击 **“运行”** 在 "**运行**" 对话框中，在 `mobsync.exe` "**打开**" 字段中键入，然后单击 **"确定"**。  
