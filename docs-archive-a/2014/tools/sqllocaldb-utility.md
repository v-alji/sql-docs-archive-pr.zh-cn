...
# <a name="sqllocaldb-utility"></a>SqlLocalDB 实用工具
  使用 `SqlLocalDB` 实用程序创建 [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssExpCurrent](../includes/ssexpcurrent-md.md)] **LocalDB**实例。 `SqlLocalDB`实用程序 ( # A0) 是一个简单的命令行工具，可让用户和开发者创建和管理 [!INCLUDE[ssExpress](../includes/ssexpress-md.md)] **LocalDB**实例。 有关如何使用**LocalDB**的信息，请参阅[SQL Server 2014 Express LocalDB](../database-engine/configure-windows/sql-server-2016-express-localdb.md)。  
