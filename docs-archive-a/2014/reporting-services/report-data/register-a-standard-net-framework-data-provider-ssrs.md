...
1.  在要在其上使用 [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] 数据访问接口的报表服务器上，导航到 bin 目录的默认位置。 Report Server 的 bin 目录的默认位置为 *\<drive>* ： \Program Files\Microsoft SQL Server MSRS10_50 \ MSSQLSERVER\Reporting services\reportserver\bin。  
