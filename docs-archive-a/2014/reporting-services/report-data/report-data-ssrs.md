...
##  <a name="terms"></a><a name="BkMk_ReportDataTerms"></a> 术语
 ...
 如果你不熟悉 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 概念，请在 Reporting Services 概念中查看以下术语[&#40;SSRS&#41;](../reporting-services-concepts-ssrs.md)：*数据连接*、*嵌入数据源*、*共享数据源*、*嵌入数据集*、*共享*数据集、*数据集查询*、*报表部件*和*数据警报*。  
