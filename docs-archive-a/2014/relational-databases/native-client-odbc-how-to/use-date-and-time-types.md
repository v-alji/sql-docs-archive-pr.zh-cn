...
ms.locfileid: "87586622"
---
# <a name="use-date-and-time-types"></a><span data-ttu-id="dafb5-102">使用日期和时间类型</span><span class="sxs-lookup"><span data-stu-id="dafb5-102">Use Date and Time Types</span></span>
  <span data-ttu-id="dafb5-103">此示例显示如何对 [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 中增加的日期/时间数据结构进行初始化。</span><span class="sxs-lookup"><span data-stu-id="dafb5-103">This sample shows how to initialize the date/time data structures that were added in [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)].</span></span> <span data-ttu-id="dafb5-104">随后准备输入值、绑定参数，并执行查询。</span><span class="sxs-lookup"><span data-stu-id="dafb5-104">It then prepares the input values, binds parameters, and executes the query.</span></span> <span data-ttu-id="dafb5-105">有关使用这些类型的详细信息，请参阅[ODBC&#41;&#40;日期和时间改进](../native-client-odbc-date-time/date-and-time-improvements-odbc.md)。</span><span class="sxs-lookup"><span data-stu-id="dafb5-105">For more information about using these types, see [Date and Time Improvements &#40;ODBC&#41;](../native-client-odbc-date-time/date-and-time-improvements-odbc.md).</span></span>  
  
## <a name="example"></a><span data-ttu-id="dafb5-106">示例</span><span class="sxs-lookup"><span data-stu-id="dafb5-106">Example</span></span>  
 <span data-ttu-id="dafb5-107">您将需要一个名为 DateTime 的 ODBC 数据源。</span><span class="sxs-lookup"><span data-stu-id="dafb5-107">You will need an ODBC data source called DateTime.</span></span> <span data-ttu-id="dafb5-108">DateTime 的默认数据库应为 tempdb。</span><span class="sxs-lookup"><span data-stu-id="dafb5-108">The default database for DateTime should be tempdb.</span></span> <span data-ttu-id="dafb5-109">此数据源必须基于 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client 的 ODBC 驱动程序。</span><span class="sxs-lookup"><span data-stu-id="dafb5-109">This data source must be based on the ODBC driver for [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client.</span></span>  
  
 <span data-ttu-id="dafb5-110">如果您要将此示例构建为在 64 位操作系统上运行的 32 位应用程序并运行该示例，则必须使用 %windir%\SysWOW64\odbcad32.exe 中的 ODBC 管理器创建 ODBC 数据源。</span><span class="sxs-lookup"><span data-stu-id="dafb5-110">If you will build and run this sample as a 32-bit application on a 64-bit operating system, you must create the ODBC data source with the ODBC Administrator in %windir%\SysWOW64\odbcad32.exe.</span></span>  
  
 <span data-ttu-id="dafb5-111">此示例连接到您的计算机上默认的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 实例。</span><span class="sxs-lookup"><span data-stu-id="dafb5-111">This sample connects to your computer's default [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] instance.</span></span> <span data-ttu-id="dafb5-112">若要连接到命名实例，请更改 ODBC 数据源的定义以使用以下格式指定实例：server\namedinstance。</span><span class="sxs-lookup"><span data-stu-id="dafb5-112">To connect to a named instance, change the definition of the ODBC data source to specify the instance using the following format: server\namedinstance.</span></span> <span data-ttu-id="dafb5-113">默认情况下，[!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] 将安装在命名实例中。</span><span class="sxs-lookup"><span data-stu-id="dafb5-113">By default, [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] installs to a named instance.</span></span>  
  
 <span data-ttu-id="dafb5-114">第一个 ([!INCLUDE[tsql](../../includes/tsql-md.md)]) 代码列表创建此示例使用的表。</span><span class="sxs-lookup"><span data-stu-id="dafb5-114">The first ([!INCLUDE[tsql](../../includes/tsql-md.md)]) code listing creates a table used by this sample.</span></span>  
  
 <span data-ttu-id="dafb5-115">使用 odbc32.lib 和 user32.lib 编译第二个 (C++) 代码列表。</span><span class="sxs-lookup"><span data-stu-id="dafb5-115">Compile the second (C++) code listing with odbc32.lib and user32.lib.</span></span> <span data-ttu-id="dafb5-116">请确保 INCLUDE 环境变量包含包含 sqlncli.msi 的目录。</span><span class="sxs-lookup"><span data-stu-id="dafb5-116">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
  
 <span data-ttu-id="dafb5-117">第三个 ([!INCLUDE[tsql](../../includes/tsql-md.md)]) 代码列表删除此示例使用的表。</span><span class="sxs-lookup"><span data-stu-id="dafb5-117">The third ([!INCLUDE[tsql](../../includes/tsql-md.md)]) code listing deletes the table used by this sample.</span></span>  
