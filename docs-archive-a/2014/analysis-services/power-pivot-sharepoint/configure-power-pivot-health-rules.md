...
##  <a name="configure-health-rules-used-to-evaluate-application-stability-powerpivot-service-application"></a><a name="bkmk_evaluate_application_stability"></a>配置用于评估 PowerPivot 服务应用程序 (应用程序稳定性的运行状况规则)   
