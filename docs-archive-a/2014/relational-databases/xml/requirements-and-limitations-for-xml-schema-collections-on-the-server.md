...
|**\<xsd:include>**|当前， [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 不支持此元素。 服务器拒绝包含此元素的 XML 架构。<br /><br /> 解决方案是可以预处理包括 \<xsd:include> 指令的 XML 架构，以将任何包括的架构的内容复制并合并到单个架构，以便上传到服务器。 有关详细信息，请参阅 [预处理架构以便合并包括的架构](preprocess-a-schema-to-merge-included-schemas.md)。|  
...
|[<xsd:simpleType> 声明的值](values-for-xsd-simpletype-declarations.md)|介绍了 \<xsd:simpleType> 声明适用的限制。|  
