 ...
 **问题**  
 单击“问题”**** 链接可打开针对某一问题的故障排除文档。 有关所有 AlwaysOn 策略问题的列表，请参阅[AlwaysOn 可用性组 (SQL Server) 的操作问题的 AlwaysOn 策略](always-on-policies-for-operational-issues-always-on-availability.md)。  
 ...
 **问题**  
 列出问题名称。 默认情况下显示此值。 有关所有 AlwaysOn 策略问题的列表，请参阅[AlwaysOn 可用性组 (SQL Server) 的操作问题的 AlwaysOn 策略](always-on-policies-for-operational-issues-always-on-availability.md)。  
...
-   **严重**。 单击此选项可显示严重问题。  
 ...
 有关所有 AlwaysOn 策略问题的列表，请参阅[AlwaysOn 可用性组 (SQL Server) 的操作问题的 AlwaysOn 策略](always-on-policies-for-operational-issues-always-on-availability.md)。  
