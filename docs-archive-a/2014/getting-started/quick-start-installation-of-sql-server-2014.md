...
|本主题介绍在卸载 [!INCLUDE[ssDQSnoversion](../includes/ssdqsnoversion-md.md)] 后或者仅卸载 DQS 服务器后如何手动删除 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] (DQS) 对象的信息。|[删除 Data Quality Server 对象](../../2014/sql-server/install/remove-data-quality-server-objects.md)|  
  
## <a name="see-also"></a>另请参阅  
 [SQL Server 2014 的产品规格](sql-server-2014-product-specifications.md)   
 SQL Server[向后兼容性](backward-compatibility.md)的[产品文档入门](../index.yml)  
