...
ms.locfileid: "87690602"
---
# <a name="display-column-and-catalog-metadata-for-sparse-columns-ole-db"></a><span data-ttu-id="e79e0-102">显示稀疏列的列和目录元数据 (OLE DB)</span><span class="sxs-lookup"><span data-stu-id="e79e0-102">Display Column and Catalog Metadata for Sparse Columns (OLE DB)</span></span>
  <span data-ttu-id="e79e0-103">此示例将创建具有三个列的表，包括一个稀疏列、一个非稀疏列和一个列集列。</span><span class="sxs-lookup"><span data-stu-id="e79e0-103">This sample creates a table with three columns: a sparse column, a column that is not a sparse column, and a columnset column.</span></span> <span data-ttu-id="e79e0-104">随后示例将显示 OLE DB 标志，指示非稀疏列和列集列的列及目录元数据。</span><span class="sxs-lookup"><span data-stu-id="e79e0-104">The sample then displays OLE DB flags showing the column and catalog metadata for the non-sparse column and the columnset column.</span></span>  
  
 <span data-ttu-id="e79e0-105">此示例适用于 [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 或更高版本。</span><span class="sxs-lookup"><span data-stu-id="e79e0-105">This sample works with [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] or later.</span></span> <span data-ttu-id="e79e0-106">有关稀疏列的详细信息，请参阅[SQL Server Native Client 中的稀疏列支持](../native-client/features/sparse-columns-support-in-sql-server-native-client.md)。</span><span class="sxs-lookup"><span data-stu-id="e79e0-106">For more information about sparse columns, see [Sparse Columns Support in SQL Server Native Client](../native-client/features/sparse-columns-support-in-sql-server-native-client.md).</span></span>  
  
## <a name="example"></a><span data-ttu-id="e79e0-107">示例</span><span class="sxs-lookup"><span data-stu-id="e79e0-107">Example</span></span>  
 <span data-ttu-id="e79e0-108">请确保 INCLUDE 环境变量包含包含 sqlncli.msi 的目录。</span><span class="sxs-lookup"><span data-stu-id="e79e0-108">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
