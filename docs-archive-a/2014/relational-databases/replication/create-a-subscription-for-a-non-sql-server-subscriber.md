...
8.  在 "**分发代理安全**" 页上，单击 "订阅者" 旁边的 "属性" **)  (按钮**，以访问**分发代理安全性**"对话框。  
...
3.  在发布服务器的发布数据库中，执行 [sp_addsubscription &#40;Transact-SQL&#41;](/sql/relational-databases/system-stored-procedures/sp-addsubscription-transact-sql)。 指定 **@publication** 、 **@subscriber** 、值为** (默认目标) ** ，为 **@destination_db** **推送**值，将值 **@subscription_type** 3 指定 **@subscriber_type** (指定 OLE DB 提供程序) 。  
