...
-   确定临时映射索引的空间。  
     ...
     在此示例中，旧书签是堆的行 ID (RID)  (8 个字节) ，而新书签是聚集键 (24 个字节，包括一个 `uniqueifier`) 。 在新旧书签之间没有重叠的列。  
...
|SORT_IN_TEMPDB = ON 时的联机索引操作|操作期间的总空间大小： 1058 MB：<br /><br /> \- 现有表和索引：363 MB\*<br /><br /> -**tempdb** (包括映射索引) ： 242 MB *<br /><br /> \- 新索引：453 MB<br /><br /> 操作后所需的总空间大小：453 MB|  
