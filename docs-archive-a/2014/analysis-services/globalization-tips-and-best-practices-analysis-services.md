...
-   中文语言和排序规则因地区而异，但通常不是简体中文就是繁体中文。  
     ...
     其他区域 (例如香港特别行政区特别行政区和澳门特别行政区) 也使用繁体中文。 在中国香港，就排序规则而言，Chinese_Hong_Kong_Stroke_90（在 SQL Server 2005 上）的使用较为常见。 在澳门特别行政区，SQL Server 2008 和更高) 版本上的 Chinese_Traditional_Stroke_Count_100 (会相当频繁地使用。  
