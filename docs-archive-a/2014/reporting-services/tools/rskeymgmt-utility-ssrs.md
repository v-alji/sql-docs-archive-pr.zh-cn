...
## <a name="file-location"></a>文件位置  
 Rskeymgmt.exe 位于** \<*drive*> ： \PROGRAM Files\Microsoft sql Server\110\Tools\Binn**或 At ** \<*drive*> ： \Program FILES (x86) \microsoft SQL Server\110\Tools\Binn**。 可以在文件系统的任何文件夹中运行此实用工具。  
