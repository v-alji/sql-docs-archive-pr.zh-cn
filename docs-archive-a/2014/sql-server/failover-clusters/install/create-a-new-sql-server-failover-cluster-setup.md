...
16. 使用 "**服务器配置-排序规则**" 选项卡为和指定非默认排序规则 [!INCLUDE[ssDE](../../../includes/ssde-md.md)] [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] 。 有关详细信息，请参阅[服务器配置 - 排序规则](../../install/server-configuration-collation.md)。  
