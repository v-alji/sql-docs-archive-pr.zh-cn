 ...
 **Type**  
 选择要使用的数据源的类型 (例如，如果使用的是 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 数据库，请选择 " [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]) "。  
