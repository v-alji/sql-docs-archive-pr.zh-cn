...
|功能|CHECK|内存优化的表不支持 CHECK 约束。 从表定义中删除该约束。<br /><br /> 有关如何缓解不支持约束的信息，请参阅[迁移 Check 和 Foreign Key 约束](../../database-engine/migrating-check-and-foreign-key-constraints.md)。|  
