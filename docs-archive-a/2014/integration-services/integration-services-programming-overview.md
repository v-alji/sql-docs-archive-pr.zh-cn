...
## <a name="integration-services-data-flow-engine"></a>Integration Services 数据流引擎  
 ...
 有关详细[信息，请](extending-packages-custom-objects/data-flow/developing-a-custom-data-flow-component.md)参阅 [使用脚本组件扩展数据流] (扩展包-脚本编写/数据流-脚本组件/扩展-数据流---------------------------- [Building Packages Programmatically](building-packages-programmatically/building-packages-programmatically.md)---------------------  
