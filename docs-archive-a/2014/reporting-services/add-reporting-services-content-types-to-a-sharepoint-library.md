...
-   [ (SharePoint 2013) 添加 Reporting Services 内容类型](#bkmk_add_single)  
...
##  <a name="to-enable-content-type-management-for-a-single-document-library-sharepoint-2013"></a><a name="bkmk_enable_content_management"></a>若要为单个文档库启用内容类型管理 (SharePoint 2013)   
...
##  <a name="to-enable-content-type-management-for-a-single-document-library-sharepoint-2010"></a><a name="bkmk_enable_content_management_2010"></a>若要为单个文档库启用内容类型管理 (SharePoint 2010)   
...
##  <a name="to-add-report-server-content-types-sharepoint-2010"></a><a name="bkmk_add_single_2010"></a> (SharePoint 2010) 添加 Report Server 内容类型  
