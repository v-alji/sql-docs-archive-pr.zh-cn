...
# <a name="troubleshoot-report-builder"></a>报表生成器故障排除
  报表生成器是 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] 的一个报表创作工具，可以用于从多种不同类型的数据源生成报表，并可将报表发布到报表服务器或 SharePoint 站点。 你创建的报表可以在报表生成器中查看，也可以在 Web 浏览器中查看，也可以作为 [!INCLUDE[msCoName](../includes/msconame-md.md)] Windows 应用程序或 SharePoint 站点的一部分来查看。  
