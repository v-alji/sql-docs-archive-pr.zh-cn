...
ms.locfileid: "87693796"
---
# <a name="streaming-support-for-blob-output-parameters"></a><span data-ttu-id="b0b66-102">BLOB 输出参数的流支持</span><span class="sxs-lookup"><span data-stu-id="b0b66-102">Streaming Support for BLOB Output Parameters</span></span>
  <span data-ttu-id="b0b66-103">本主题包含一个示例，显示针对 BLOB 输出参数的流支持，它将 BLOB 输出参数绑定为 ISequentialStreams。</span><span class="sxs-lookup"><span data-stu-id="b0b66-103">This topic contains a sample that shows streaming support for BLOB output parameters, which binds BLOB output parameters as ISequentialStreams.</span></span>  
  
 <span data-ttu-id="b0b66-104">可以在 IMultipleResults::GetResult 中锁定输出参数，并且接收 DB_E_OBJECTOPEN 返回值。</span><span class="sxs-lookup"><span data-stu-id="b0b66-104">You can become blocked on output parameters in IMultipleResults::GetResult, receiving DB_E_OBJECTOPEN return value.</span></span> <span data-ttu-id="b0b66-105">调用方应检查是否存在挂起的 blob 参数，并且完全读取它们或释放它们。</span><span class="sxs-lookup"><span data-stu-id="b0b66-105">The caller should to check for pending blob parameters, and either read them completely or release them.</span></span>  
  
## <a name="example"></a><span data-ttu-id="b0b66-106">示例</span><span class="sxs-lookup"><span data-stu-id="b0b66-106">Example</span></span>  
  
### <a name="code"></a><span data-ttu-id="b0b66-107">代码</span><span class="sxs-lookup"><span data-stu-id="b0b66-107">Code</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="b0b66-108">另请参阅</span><span class="sxs-lookup"><span data-stu-id="b0b66-108">See Also</span></span>  
 [<span data-ttu-id="b0b66-109">BLOB 和 OLE 对象</span><span class="sxs-lookup"><span data-stu-id="b0b66-109">BLOBs and OLE Objects</span></span>](blobs-and-ole-objects.md)  
