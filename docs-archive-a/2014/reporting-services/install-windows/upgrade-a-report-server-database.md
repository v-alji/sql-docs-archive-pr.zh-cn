 ...
 **SharePoint 模式：** 在 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] SharePoint 模式中，Report Server 数据库实际上是为服务应用程序的每个实例创建的数据库的集合 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 。  
