...
# <a name="how-to-debug-custom-assemblies"></a>如何：调试自定义程序集
  [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] 提供了一些调试工具，这些工具可帮助您分析您的自定义程序集代码和查找其中的错误。 要使用的最佳工具取决于您试图完成的任务。 此示例使用 [!INCLUDE[vsOrcas](../../includes/vsorcas-md.md)]。  
