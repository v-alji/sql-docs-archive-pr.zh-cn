...
##  <a name="to-configure-sql-server-data-tools-bi-ssdt-to-publish-to-a-local-report-server"></a><a name="bkmk_configure_ssdt"></a>将 SQL Server Data Tools BI (SSDT) 配置为发布到本地报表服务器  
...
1.  在 "开始" 屏幕上，键入 `sql server` ，然后右键单击 " **SQL Server Data Tools For Visual Studio**"。 单击 **“以管理员身份运行”**。  
