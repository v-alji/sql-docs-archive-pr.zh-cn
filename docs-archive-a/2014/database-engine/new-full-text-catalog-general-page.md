 ...
 **区分重音**  
 指示目录是敏感还是不区分发音符号，如波形符 (**~**) 、锐音符 (**") **) 或元音变音符 () **¨** 。 如果您选择 **“不区分”**，则在与此全文目录相关联的全文索引中将忽略标注字符。 有关发音符号的信息，请参阅 Merriam-Webster 网站中的[发音符](https://www.merriam-webster.com/dictionary/diacritic)。  
