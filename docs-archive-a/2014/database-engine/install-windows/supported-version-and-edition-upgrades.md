...
|升级前的版本|升级到的版本|  
|------------------|----------------|  
|[!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]企业 (Server + CAL 和核心) <sup>2</sup>| Business Intelligence|  
...
|版本升级自|版本升级到|  
|--------------------------|------------------------|  
|[!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]企业 (Server + CAL 许可证) <sup>2</sup>|[!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] Enterprise（内核许可证）|  
