...
---
# <a name="preprocess-a-schema-to-merge-included-schemas"></a><span data-ttu-id="15e6e-102">预处理架构以便合并包括的架构</span><span class="sxs-lookup"><span data-stu-id="15e6e-102">Preprocess a Schema to Merge Included Schemas</span></span>
  <span data-ttu-id="15e6e-103">W3C XSD **include** 元素支持架构模块性，通过功能可以将 XML 架构分区到多个物理文件中。</span><span class="sxs-lookup"><span data-stu-id="15e6e-103">The W3C XSD **include** element provides support for schema modularity in which an XML schema can be partitioned into more than one physical file.</span></span> [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] <span data-ttu-id="15e6e-104">当前尚不支持此元素。</span><span class="sxs-lookup"><span data-stu-id="15e6e-104">currently does not support this element.</span></span> <span data-ttu-id="15e6e-105">服务器将拒绝包含此元素的 XML 架构。</span><span class="sxs-lookup"><span data-stu-id="15e6e-105">XML schemas that include this element will be rejected by the server.</span></span>  
  
 <span data-ttu-id="15e6e-106">一种解决方法是，可以预处理包括 \<xsd:include> 指令的 XML 架构，来复制所有包含的架构的内容并将其合并为单个架构，以上传到服务器。</span><span class="sxs-lookup"><span data-stu-id="15e6e-106">As a solution, XML schemas that include the \<xsd:include> directive can be preprocessed to copy and merge the contents of any included schemas into a single schema for uploading to the server.</span></span> <span data-ttu-id="15e6e-107">以下 C# 代码可用于预处理。</span><span class="sxs-lookup"><span data-stu-id="15e6e-107">The following C# code can be used for the preprocessing.</span></span> <span data-ttu-id="15e6e-108">代码前面部分的注释提供了有关如何使用代码的信息。</span><span class="sxs-lookup"><span data-stu-id="15e6e-108">The comments in the early part of the code provide information about how to use it.</span></span>  
...
## <a name="testing-the-preprocessor-tool"></a><span data-ttu-id="15e6e-109">测试预处理器工具</span><span class="sxs-lookup"><span data-stu-id="15e6e-109">Testing the Preprocessor Tool</span></span>  
 <span data-ttu-id="15e6e-110">您可以使用以下 XSD 架构来测试预处理器工具：</span><span class="sxs-lookup"><span data-stu-id="15e6e-110">You can use the following XSD schemas to test the preprocessor tool:</span></span>  
  
### <a name="books_commonxsd"></a><span data-ttu-id="15e6e-111">books_common.xsd</span><span class="sxs-lookup"><span data-stu-id="15e6e-111">books_common.xsd</span></span>  
...
### <a name="booksxsd"></a><span data-ttu-id="15e6e-112">books.xsd</span><span class="sxs-lookup"><span data-stu-id="15e6e-112">books.xsd</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="15e6e-113">另请参阅</span><span class="sxs-lookup"><span data-stu-id="15e6e-113">See Also</span></span>  
 [<span data-ttu-id="15e6e-114">XML 架构集合 (SQL Server)</span><span class="sxs-lookup"><span data-stu-id="15e6e-114">XML Schema Collections &#40;SQL Server&#41;</span></span>](xml-schema-collections-sql-server.md)  
