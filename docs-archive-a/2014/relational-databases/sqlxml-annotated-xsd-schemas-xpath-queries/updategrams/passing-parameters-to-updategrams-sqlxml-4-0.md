...
2.  使用 ADO () Sqlxml4test.vbs 准备 SQLXML 4.0 测试脚本，以便通过在以下内容后添加以下行来[执行 sqlxml 4.0 查询](../../sqlxml/using-ado-to-execute-sqlxml-4-0-queries.md)以执行 updategram `cmd.Properties("Output Stream").Value = outStream` ：  
