...
## <a name="see-also"></a>另请参阅
 [安装和部署 Sharepoint server 2010](https://technet.microsoft.com/sharepoint/ee518643.aspx) [ (sharepoint server 2010) 的三层场的多个服务器](https://go.microsoft.com/fwlink/?linkID=219834)
