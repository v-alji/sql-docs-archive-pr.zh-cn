...
-   **XMLA**  
     ...
     [!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssASCurrent](../../includes/ssascurrent-md.md)]支持 XML for Analysis (XMLA) 作为协议以便与客户端应用程序进行通信。 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 还支持其他扩展了 XML for Analysis 规范的命令。  
