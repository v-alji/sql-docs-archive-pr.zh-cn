...
-   [ (SharePoint 模式下创建和管理共享计划) ](#bkmk_sharepoint)  
...
##  <a name="create-and-manage-shared-schedules-sharepoint-mode"></a><a name="bkmk_sharepoint"></a> (SharePoint 模式下创建和管理共享计划)   
...
##  <a name="create-and-manage-shared-schedules-native-mode"></a><a name="bkmk_native"></a> (本机模式下创建和管理共享计划)   
