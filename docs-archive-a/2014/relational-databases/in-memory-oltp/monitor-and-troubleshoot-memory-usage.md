...
```
 ...
 有关详细信息，请参阅[sys.databases) dm_os_memory_objects (](/sql/relational-databases/system-dynamic-management-views/sys-dm-os-memory-objects-transact-sql)。
...
```
 ...
 有关详细信息，请参阅[sys.databases) dm_os_memory_clerks (](/sql/relational-databases/system-dynamic-management-views/sys-dm-os-memory-clerks-transact-sql)。
