...
# <a name="building-applications-using-the-web-service-and-the-net-framework"></a>Building Applications Using the Web Service and the .NET Framework
  利用 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] ，你可以使用熟悉的编程构造（如方法、基元类型和用户定义的复杂类型）来处理 Web 服务。 [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] 包含可用来创建 Web 服务客户端的基础结构和工具，这些客户端可以调用任何符合万维网联盟 (W3C) 标准的 Web 服务。  
...
|主题|说明|  
|-----------|-----------------|  
|[创建 Web 服务代理](creating-the-web-service-proxy.md)|介绍使用将代理类添加到项目的方法 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] 。|  
|[Web 服务身份验证](web-service-authentication.md)|介绍如何对针对报表服务器 Web 服务的调用进行身份验证。|  
|[调用 Web 服务方法](calling-web-service-methods.md)|介绍如何在中使用 SOAP API 调用 Web 服务方法 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] 。|  
