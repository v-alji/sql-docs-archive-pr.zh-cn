...
###  <a name="recommendations"></a><a name="Recommendations"></a> 建议  
 默认情况下，SQLDIAG 存储在 SQL Server 实例目录的本地 LOG 文件夹下，例如 "C\Program Files\Microsoft SQL Server\MSSQL12. \<InstanceName>AlwaysOn 故障转移群集实例的拥有节点 (FCI) 的 \MSSQL\LOG '。 每个 SQLDIAG 日志文件的大小固定为 100 MB。 在被回收用于新日志之前，计算机上有十个这样的日志文件。  
