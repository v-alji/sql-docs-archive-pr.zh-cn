...
###  <a name="specifying-a-backup-file-by-using-its-physical-name-transact-sql"></a><a name="BackupFileUsingPhysicalName"></a>通过使用 (Transact-sql) 的物理名称指定备份文件  
...
###  <a name="specifying-a-backup-tape-by-using-its-physical-name-transact-sql"></a><a name="BackupTapeUsingPhysicalName"></a>使用其物理名称指定备份磁带 (Transact-sql)   
