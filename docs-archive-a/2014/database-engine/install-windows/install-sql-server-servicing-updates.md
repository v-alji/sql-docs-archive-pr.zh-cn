...
## <a name="installing-updates-for-sscurrent-after-it-has-already-been-installed"></a>在已安装 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 后为其安装更新  
 ...
 根据服务发布的类型，可以通过 Microsoft 更新 (MU) 、Microsoft 下载中心和/或客户支持服务修补程序服务器提供 SQL Server 更新。 SQL Server 的安全更新和关键更新由 Microsoft 更新 (自动提供，以便通过控制面板) 中的 Windows 更新来查看所需的这些更新。 在 MU 上，Service Pack 可作为可选/重要下载和下载中心提供。 在 CU 知识库文章中提供的 Microsoft 修补程序下载服务器上提供了累积更新。  
