...
# <a name="servernetworkprotocol-class"></a>ServerNetworkProtocol 类
  [ServerNetworkProtocol Class] ServerNetworkProtocol-class.md) 表示在的实例上安装的网络协议 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] ，该协议允许通过网络与客户端进行通信。  
  
 利用 [ServerNetworkProtocol Class] ServerNetworkProtocol-class.md) ，你可以：  
