...
```  
 ...
 AllowPartiallyTrustedCallersAttribute 仅当被具有强名称的程序集在程序集级别应用时才生效****。 有关在程序集级别应用属性的详细信息，请参阅 SDK 文档中的 "应用属性" [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] 。  
