...
-   复制 Transact-sql 编程：执行[sp_addarticle &#40;transact-sql&#41;](/sql/relational-databases/system-stored-procedures/sp-addarticle-transact-sql) ，并将参数的值指定为 "serializable proc exec" (推荐) 或 "proc exec" **@type** 。 有关如何定义项目的详细信息，请参阅[定义项目](../publish/define-an-article.md)。  
