...
## <a name="remarks"></a>备注  
 ...
 此外，大容量复制实用工具 (**bcp**) 可以将用户定义的数据格式保存在可由引用的文件中 `bcp_readfmt` 。 有关**bcp**实用工具和**bcp**数据格式文件的结构的详细信息，请参阅[批量导入和导出数据 &#40;SQL Server&#41;](../import-export/bulk-import-and-export-of-data-sql-server.md)。  
