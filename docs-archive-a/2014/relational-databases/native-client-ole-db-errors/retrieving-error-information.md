...
ms.locfileid: "87589541"
---
# <a name="retrieving-error-information"></a><span data-ttu-id="380ac-102">检索错误信息</span><span class="sxs-lookup"><span data-stu-id="380ac-102">Retrieving Error Information</span></span>
  <span data-ttu-id="380ac-103">此示例从 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 提供程序公开的各种错误接口中获取信息。</span><span class="sxs-lookup"><span data-stu-id="380ac-103">This example obtains information from the various error interfaces exposed by the [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB provider.</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="380ac-104">另请参阅</span><span class="sxs-lookup"><span data-stu-id="380ac-104">See Also</span></span>  
 [<span data-ttu-id="380ac-105">错误</span><span class="sxs-lookup"><span data-stu-id="380ac-105">Errors</span></span>](errors.md)  
