...
## <a name="in-this-section"></a>本节内容  
 ...
 讨论 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 如何支持 (UDT) 的用户定义类型，它通过允许您在数据库中存储对象和自定义数据结构，从而扩展了 SQL 类型系统 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 。  
