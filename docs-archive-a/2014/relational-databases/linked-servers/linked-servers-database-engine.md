...
-   OLE DB 数据源
 ...
 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client OLE DB 提供程序 (PROGID： SQLNCLI11) 是的官方 OLE DB 提供程序 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 。
