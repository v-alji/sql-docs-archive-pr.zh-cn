...
>  稀疏文件按 64 KB 的增量增长；因此，磁盘上稀疏文件的大小始终是 64 KB 的倍数。  
 ...
 若要查看快照的每个稀疏文件当前正在磁盘上使用的字节数，请查询**size_on_disk_bytes** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [sys.databases dm_io_virtual_file_stats](/sql/relational-databases/system-dynamic-management-views/sys-dm-io-virtual-file-stats-transact-sql)动态管理视图的 size_on_disk_bytes 列。  
