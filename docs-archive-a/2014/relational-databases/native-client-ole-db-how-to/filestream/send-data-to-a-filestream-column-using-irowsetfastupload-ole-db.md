...
ms.locfileid: "87581170"
---
# <a name="send-data-to-a-filestream-column-using-irowsetfastupload-ole-db"></a><span data-ttu-id="8e005-102">使用 IRowsetFastUpload 向 FILESTREAM 列发送数据 (OLE DB)</span><span class="sxs-lookup"><span data-stu-id="8e005-102">Send Data to a FILESTREAM Column Using IRowsetFastUpload (OLE DB)</span></span>
  <span data-ttu-id="8e005-103">此示例使用 IRowsetFastUpload 接口向 filestream 列发送大小在 4 MB 与 4 GB 之间的数据。</span><span class="sxs-lookup"><span data-stu-id="8e005-103">This sample uses the IRowsetFastUpload interface to send between 4MB and 4GB of data to a filestream column.</span></span>  
  
 <span data-ttu-id="8e005-104">有关 filestream 功能的详细信息，请参阅[Filestream 支持 &#40;OLE DB&#41;](../../native-client/ole-db/filestream-support-ole-db.md)。</span><span class="sxs-lookup"><span data-stu-id="8e005-104">For more information on the filestream feature, see [FILESTREAM Support &#40;OLE DB&#41;](../../native-client/ole-db/filestream-support-ole-db.md).</span></span>  
  
## <a name="example"></a><span data-ttu-id="8e005-105">示例</span><span class="sxs-lookup"><span data-stu-id="8e005-105">Example</span></span>  
 <span data-ttu-id="8e005-106">编译和运行此示例前，先启用 FILESTREAM 支持（[启用和配置 FILESTREAM](../../blob/enable-and-configure-filestream.md)）。</span><span class="sxs-lookup"><span data-stu-id="8e005-106">Before you compile and run this sample, enable FILESTREAM support ([Enable and Configure FILESTREAM](../../blob/enable-and-configure-filestream.md)).</span></span>  
  
 <span data-ttu-id="8e005-107">请确保 INCLUDE 环境变量包含包含 sqlncli.msi 的目录。</span><span class="sxs-lookup"><span data-stu-id="8e005-107">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
  
 <span data-ttu-id="8e005-108">该服务器必须具有名为 C:\DBFsa 的目录，示例将在其中创建数据库。</span><span class="sxs-lookup"><span data-stu-id="8e005-108">The server must have a directory called C:\DBFsa; this is where the sample will create the database.</span></span> <span data-ttu-id="8e005-109">您的 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 实例必须对此位置具有写访问权限（例如，采用本地系统帐户登录）。</span><span class="sxs-lookup"><span data-stu-id="8e005-109">Your instance of [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] must have write access to this location (for example, log on as a local system account).</span></span>  
  
 <span data-ttu-id="8e005-110">复制第一个代码列表，并将其粘贴到名为 ISSHelper.h 的文件中。</span><span class="sxs-lookup"><span data-stu-id="8e005-110">Copy the first code listing and paste it into a file called ISSHelper.h.</span></span>  
  
 <span data-ttu-id="8e005-111">复制第二个代码列表，并将其粘贴到名为 ISSHelper.cpp 的文件中。</span><span class="sxs-lookup"><span data-stu-id="8e005-111">Copy the second code listing and paste it into a file called ISSHelper.cpp.</span></span>  
  
 <span data-ttu-id="8e005-112">复制第三个代码列表，并将其粘贴到名为 IRowsetFastLoadUpload.cpp 的文件中。</span><span class="sxs-lookup"><span data-stu-id="8e005-112">Copy the third code listing and paste it into a file called IRowsetFastLoadUpload.cpp.</span></span>  
  
 <span data-ttu-id="8e005-113">编译 IRowsetFastLoadUpload.cpp、ISSHelper.cpp、ole32.lib 和 oleaut32.lib。</span><span class="sxs-lookup"><span data-stu-id="8e005-113">Compile IRowsetFastLoadUpload.cpp, ISSHelper.cpp, ole32.lib, and oleaut32.lib.</span></span>  
  
 <span data-ttu-id="8e005-114">运行此示例时，必须传递服务器名称或“服务器\实例名称”，以及一个介于 4 MB (0x400001) 与 4 GB (0xFFFFFFFF) 之间的值，指示写入的数据量。</span><span class="sxs-lookup"><span data-stu-id="8e005-114">When you run this sample, you must pass the name of a server, or a server\instance_name, as well as a value between 4 MB (0x400001) and 4 GB (0xFFFFFFFF) indicating the amount of data to write.</span></span>  
  
 <span data-ttu-id="8e005-115">第四个 ([!INCLUDE[tsql](../../../includes/tsql-md.md)]) 代码列表删除此示例创建的数据库。</span><span class="sxs-lookup"><span data-stu-id="8e005-115">The fourth ([!INCLUDE[tsql](../../../includes/tsql-md.md)]) code listing deletes the database created by this sample.</span></span>  
