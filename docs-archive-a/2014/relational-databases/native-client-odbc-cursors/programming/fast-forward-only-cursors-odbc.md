...
-   当检测到达游标末尾时，服务器自动关闭游标。 应用程序仍必须 SQL_CLOSE) 调用[SQLCloseCursor](../../native-client-odbc-api/sqlclosecursor.md)或[SQLFreeStmt](../../native-client-odbc-api/sqlfreestmt.md) (，但驱动程序不必向服务器发送关闭请求。 这就省去了通过网络往返服务器。  
