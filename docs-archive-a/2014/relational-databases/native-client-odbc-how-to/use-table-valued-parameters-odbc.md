...
ms.locfileid: "87577614"
---
# <a name="use-table-valued-parameters-odbc"></a><span data-ttu-id="be14b-102">使用表值参数 (ODBC)</span><span class="sxs-lookup"><span data-stu-id="be14b-102">Use Table-Valued Parameters (ODBC)</span></span>
  <span data-ttu-id="be14b-103">此示例演示了如何使用表值参数通过调用一次服务器插入多个行和多个列。</span><span class="sxs-lookup"><span data-stu-id="be14b-103">This sample shows how to use table-valued parameters to insert multiple rows, with multiple columns, with one call to the server.</span></span>  
  
 <span data-ttu-id="be14b-104">有关表值参数的详细信息，请参阅[ODBC&#41;&#40;表值参数](../native-client-odbc-table-valued-parameters/table-valued-parameters-odbc.md)。</span><span class="sxs-lookup"><span data-stu-id="be14b-104">For more information about table-valued parameters, see [Table-Valued Parameters &#40;ODBC&#41;](../native-client-odbc-table-valued-parameters/table-valued-parameters-odbc.md).</span></span> <span data-ttu-id="be14b-105">有关使用表值参数的更多示例，请参阅[ODBC 表值参数编程示例](../../database-engine/dev-guide/odbc-table-valued-parameter-programming-examples.md)。</span><span class="sxs-lookup"><span data-stu-id="be14b-105">For more samples using table-valued parameters, see [ODBC Table-Valued Parameter Programming Examples](../../database-engine/dev-guide/odbc-table-valued-parameter-programming-examples.md).</span></span>  
  
## <a name="example"></a><span data-ttu-id="be14b-106">示例</span><span class="sxs-lookup"><span data-stu-id="be14b-106">Example</span></span>  
 <span data-ttu-id="be14b-107">您将需要名为 TVPDemo 的 ODBC 数据源。</span><span class="sxs-lookup"><span data-stu-id="be14b-107">You will need an ODBC data source called TVPDemo.</span></span> <span data-ttu-id="be14b-108">TVPDemo 的默认数据库可以是您计算机上的任何测试数据库。</span><span class="sxs-lookup"><span data-stu-id="be14b-108">The default database for TVPDemo can be any test database on your computer.</span></span> <span data-ttu-id="be14b-109">此数据源必须基于 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client 的 ODBC 驱动程序。</span><span class="sxs-lookup"><span data-stu-id="be14b-109">This data source must be based on the ODBC driver for [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client.</span></span>  
  
 <span data-ttu-id="be14b-110">如果您要将此示例构建为在 64 位操作系统上运行的 32 位应用程序并运行该示例，则必须使用 %windir%\SysWOW64\odbcad32.exe 中的 ODBC 管理器创建 ODBC 数据源。</span><span class="sxs-lookup"><span data-stu-id="be14b-110">If you will build and run this sample as a 32-bit application on a 64-bit operating system, you must create the ODBC data source with the ODBC Administrator in %windir%\SysWOW64\odbcad32.exe.</span></span>  
  
 <span data-ttu-id="be14b-111">此示例连接到您的计算机上默认的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 实例。</span><span class="sxs-lookup"><span data-stu-id="be14b-111">This sample connects to your computer's default [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] instance.</span></span> <span data-ttu-id="be14b-112">若要连接到命名实例，请更改 ODBC 数据源的定义以使用以下格式指定实例：server\namedinstance。</span><span class="sxs-lookup"><span data-stu-id="be14b-112">To connect to a named instance, change the definition of the ODBC data source to specify the instance using the following format: server\namedinstance.</span></span> <span data-ttu-id="be14b-113">默认情况下，[!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] 将安装在命名实例中。</span><span class="sxs-lookup"><span data-stu-id="be14b-113">By default, [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] installs to a named instance.</span></span>  
  
 <span data-ttu-id="be14b-114">使用 odbc32.lib 和 user32.lib 编译 (C++) 代码列表。</span><span class="sxs-lookup"><span data-stu-id="be14b-114">Compile the (C++) code listing with odbc32.lib and user32.lib.</span></span> <span data-ttu-id="be14b-115">请确保 INCLUDE 环境变量包含包含 sqlncli.msi 的目录。</span><span class="sxs-lookup"><span data-stu-id="be14b-115">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
