...
## <a name="overview"></a>概述  
 ...
 [!INCLUDE[ss_smartbackup](../includes/ss-smartbackup-md.md)]还会使用与手动备份到 Azure 存储 (SQL Server 备份到 URL) 时使用的相同日志记录。 有关备份到 URL 相关问题的详细信息，请参阅[SQL Server 备份到 Url 最佳做法和故障排除](../relational-databases/backup-restore/sql-server-backup-to-url-best-practices-and-troubleshooting.md)中的故障排除部分  
