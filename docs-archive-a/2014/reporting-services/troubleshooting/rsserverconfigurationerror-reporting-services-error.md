...
## <a name="user-action"></a>用户操作  
 ...
 若要查看错误附带的其他错误消息信息 `rsServerConfiguration` ，请查看 Report Server 跟踪日志文件，这些文件位于 \MICROSOFT SQL Server\MSRS12. \<instancename >\Reporting Services\logfiles。 有关详细信息，请参阅 [Reporting Services 日志文件和源](../report-server/reporting-services-log-files-and-sources.md)。  
