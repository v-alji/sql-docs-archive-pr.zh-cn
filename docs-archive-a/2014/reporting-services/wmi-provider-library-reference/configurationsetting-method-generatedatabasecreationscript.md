...
> [!IMPORTANT]  
>  从开始 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] ， *IsSharePointMode* = `True` 不支持 IsSharePointMode，因为在 sharepoint 模式下， [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 是 sharepoint 共享服务，且不受 WMI 提供程序的控制。 您应始终将此参数设置为 `False`。  
