 ...
 **使用此图像**  
 ...
 如果您选择 **“外部”** 选项，请键入相应图像的 URL。 对于发布到配置为纯模式的 Report Server 的报表，请使用完整路径或相对路径 (例如，http:// *\<servername>* /images/image1.jpg) 。 对于发布到在 SharePoint 集成模式下配置的 Report Server 的报表，请使用完全限定的 URL (例如 http:// *\<SharePointservername>/\<site>* /Documents/images/image1.jpg) 。  
