...
## <a name="locking-table-hints"></a>锁定表提示  
  (表提示的锁定提示[&#40;transact-sql&#41;](/sql/t-sql/queries/hints-transact-sql-table)) 例如，HOLDLOCK 和 XLOCK 可以与基于磁盘的表一起使用，以获得 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 超过指定隔离级别所需的锁。  
