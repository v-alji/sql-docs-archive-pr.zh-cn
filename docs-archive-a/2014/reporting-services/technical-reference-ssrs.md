...
# <a name="technical-reference-ssrs"></a>技术参考 (SSRS)
  查找有关在中使用或管理的工具和 PowerShell 参考文档 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] 。  
