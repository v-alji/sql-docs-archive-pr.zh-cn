...
---
# <a name="what39s-new-database-engine"></a>新增 (数据库引擎&#39;) 
...
###  <a name="buffer-pool-extension"></a><a name="Buffer"></a>缓冲池扩展  
 [缓冲池扩展](configure-windows/buffer-pool-extension.md)提供了固态驱动器 (SSD) 的无缝集成， (NvRAM) 扩展到 [!INCLUDE[ssDE](../includes/ssde-md.md)] 缓冲池，以显著提高 i/o 吞吐量。  
