...
|**权限**|19|表示所检查的权限类型的整型值。 值为：<br /><br /> **1** = 全选<br /><br /> **2** = 全部更新<br /><br /> **4** = 引用全部<br /><br /> **8** = 插入<br /><br /> **16** = 删除<br /><br /> **32** = 仅执行 (过程) <br /><br /> **4096** = 至少选择一列 () <br /><br /> **8192** = 更新任何<br /><br /> **16384** = REFERENCES ANY|  
...
|**： Sqlhandle**|63|基于即席查询文本或 SQL 对象的数据库和对象 ID 的 64 位哈希运算。 此值可传递给**sys. dm_exec_sql_text ( # B1**来检索关联的 sql 文本。|  
