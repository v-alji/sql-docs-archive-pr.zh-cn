...
### <a name="obtaining-documentation-for-ssnoversion"></a>获取 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 的文档  
 可以在线获取 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 文档。 有关详细信息，请参阅[将产品文档用于 SQL Server](../index.yml)。  
...
### <a name="customer-service"></a>Customer Service  
 你可以 [!INCLUDE[msCoName](../includes/msconame-md.md)] 通过在 800 A.M. 拨打 () 6:30 892-5234 拨打文本电话联系销售信息中心 销售 支持服务联系。  
