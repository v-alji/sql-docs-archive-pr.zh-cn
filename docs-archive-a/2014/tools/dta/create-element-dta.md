...
|**子元素**|[索引元素 (DTA)](index-element-dta.md)<br /><br /> `Statistics`元素 (参阅[数据库引擎优化顾问 XML 架构](https://schemas.microsoft.com/sqlserver/)) <br /><br /> `Heap`元素 (参阅[数据库引擎优化顾问 XML 架构](https://schemas.microsoft.com/sqlserver/)) |  
