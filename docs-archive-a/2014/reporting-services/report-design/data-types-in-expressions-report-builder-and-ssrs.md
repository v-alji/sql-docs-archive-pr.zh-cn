...
-   在文本框中，使用表达式提取部分字符串。 例如：  
 ...
 有关将字符串转换为数据类型的详细信息 `DateTime` ，请参阅[分析日期和时间字符串](https://go.microsoft.com/fwlink/?LinkId=89703)、[设置特定区域性的日期和时间格式](https://go.microsoft.com/fwlink/?LinkId=89704)，以及在 MSDN 上的[DateTime、DateTimeOffset 和 TimeZoneInfo 之间进行选择](https://go.microsoft.com/fwlink/?linkid=110652)。  
