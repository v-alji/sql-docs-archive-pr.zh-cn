...
ms.locfileid: "87687875"
---
# <a name="read-a-filestream-column-to-file-using-ibcpsession-ole-db"></a><span data-ttu-id="c50a1-102">使用 IBCPSession 将 FILESTREAM 列读入文件 (OLE DB)</span><span class="sxs-lookup"><span data-stu-id="c50a1-102">Read a FILESTREAM Column to File Using IBCPSession (OLE DB)</span></span>
  <span data-ttu-id="c50a1-103">此示例使用 IBCPSession 接口将 filestream 列读入文件并编写格式化文件。</span><span class="sxs-lookup"><span data-stu-id="c50a1-103">This sample reads a filestream column to a file using the IBCPSession interface and writes a format file.</span></span>  
  
 <span data-ttu-id="c50a1-104">有关 filestream 功能的详细信息，请参阅[Filestream 支持 &#40;OLE DB&#41;](../../native-client/ole-db/filestream-support-ole-db.md)。</span><span class="sxs-lookup"><span data-stu-id="c50a1-104">For more information on the filestream feature, see [FILESTREAM Support &#40;OLE DB&#41;](../../native-client/ole-db/filestream-support-ole-db.md).</span></span>  
  
## <a name="example"></a><span data-ttu-id="c50a1-105">示例</span><span class="sxs-lookup"><span data-stu-id="c50a1-105">Example</span></span>  
 <span data-ttu-id="c50a1-106">请确保 INCLUDE 环境变量包含包含 sqlncli.msi 的目录。</span><span class="sxs-lookup"><span data-stu-id="c50a1-106">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
  
 <span data-ttu-id="c50a1-107">使用以下示例之一创建此示例读取的表：</span><span class="sxs-lookup"><span data-stu-id="c50a1-107">Use one of the following samples to create the table that this sample reads from:</span></span>  
  
-   [<span data-ttu-id="c50a1-108">使用绑定到 ICommandText 参数的 ISequentialStream 向 FILESTREAM 列发送数据 (OLE DB)</span><span class="sxs-lookup"><span data-stu-id="c50a1-108">Send Data to a FILESTREAM Column Using ISequentialStream Bound to ICommandText Parameter &#40;OLE DB&#41;</span></span>](send-data-to-filestream-isequentialstream-bound-to-icommandtext.md)  
  
-   [<span data-ttu-id="c50a1-109">使用 IRowsetFastUpload 向 FILESTREAM 列发送数据 (OLE DB)</span><span class="sxs-lookup"><span data-stu-id="c50a1-109">Send Data to a FILESTREAM Column Using IRowsetFastUpload &#40;OLE DB&#41;</span></span>](send-data-to-a-filestream-column-using-irowsetfastupload-ole-db.md)  
  
 <span data-ttu-id="c50a1-110">复制第一个代码列表，并将其粘贴到名为 ISSHelper.h 的文件中。</span><span class="sxs-lookup"><span data-stu-id="c50a1-110">Copy the first code listing and paste it into a file called ISSHelper.h.</span></span>  
  
 <span data-ttu-id="c50a1-111">复制第二个代码列表，并将其粘贴到名为 ISSHelper.cpp 的文件中。</span><span class="sxs-lookup"><span data-stu-id="c50a1-111">Copy the second code listing and paste it into a file called ISSHelper.cpp.</span></span>  
  
 <span data-ttu-id="c50a1-112">复制第三个代码列表，并将其粘贴到名为 IBCPSession.cpp 的文件中。</span><span class="sxs-lookup"><span data-stu-id="c50a1-112">Copy the third code listing and paste it into a file called IBCPSession.cpp.</span></span>  
  
 <span data-ttu-id="c50a1-113">编译 IBCPSession.cpp、ISSHelper.cpp、ole32.lib 和 oleaut32.lib。</span><span class="sxs-lookup"><span data-stu-id="c50a1-113">Compile IBCPSession.cpp, ISSHelper.cpp, ole32.lib, and oleaut32.lib.</span></span>  
  
 <span data-ttu-id="c50a1-114">运行该示例时，必须传递一个服务器名称（或 server\instance_name）以及一个将创建的格式化文件的名称。</span><span class="sxs-lookup"><span data-stu-id="c50a1-114">When this sample is run, you must pass a server name (or server\instance_name) and a name for the format file it will create.</span></span>  
