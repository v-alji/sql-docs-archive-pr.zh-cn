...
-   如果现有 PowerPivot 安装是 [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] ，则 [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] 需要将 Service Pack 2 (SP2) 升级到 [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)] 。  
  
-   如果现有 PowerPivot 安装是 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] ，则 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 升级到需要 Service Pack 1 (SP1) [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)] 。  
...
8.  对场中的每个 SQL Server Analysis Services (PowerPivot) 服务**重复该过程**： 1) 运行 SQL Server 安装程序 2) 运行 PowerPivot 配置工具。  
