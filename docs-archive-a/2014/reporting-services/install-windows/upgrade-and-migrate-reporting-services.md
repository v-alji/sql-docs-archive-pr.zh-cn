...
4.  安装程序为 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 程序文件创建新的文件夹。 安装的程序文件夹 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 包括 MSRS12。 \<*instance name*>
...
8.  安装程序将报表服务器数据库升级到新架构并通过为角色添加数据库所有者权限来修改 `RSExecRole`。 仅当从 SP1 之前的升级时，才会执行此步骤 [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 。
...
##  <a name="sharepoint-mode-upgrade-and-migration-scenarios"></a><a name="bkmk_sharePoint_scenarios"></a> SharePoint 模式升级和迁移方案
 以下部分介绍从 sharepoint 模式的指定版本升级或迁移 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 到 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] sharepoint 模式所需的问题和基本步骤 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 。
...
### <a name="sssql11-to-sssql14"></a>[!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 至 [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]
...
### <a name="sskilimanjaro-to-sssql14"></a>[!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] 至 [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]
