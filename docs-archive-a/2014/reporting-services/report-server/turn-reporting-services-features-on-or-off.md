...
2.  在对象资源管理器中，右键单击 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 节点，指向 "**策略**"，然后单击 "**方面**"。  
...
4.  在 **“方面属性”** 下：  
    ...
    -   若要启用预定的事件和传递，请将**ScheduleEventsAndReportDeliveryEnabled**设置为 `True` 。  
...
4.  在 **“方面属性”** 下：  
    ...
    -   若要启用报表管理器，请将**ReportManagerEnabled**设置为 `True` 。  
