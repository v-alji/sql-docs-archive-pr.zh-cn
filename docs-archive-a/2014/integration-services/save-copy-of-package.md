 ...
 **包路径**  
 键入包路径，或单击 "浏览** ( ) ...** " 按钮，然后找到要在其中存储包的文件夹。  
  
 **保护级别**  
 单击 "浏览** ( ) ...** " 按钮，然后在 "**包保护级别**" 对话框中更新保护级别。 有关详细信息，请参阅 [“包和项目保护级别”对话框](../../2014/integration-services/package-and-project-protection-level-dialog-box.md)。  
