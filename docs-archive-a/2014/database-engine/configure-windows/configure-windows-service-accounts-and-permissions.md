...
-   **[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]**-为商业智能应用程序 (OLAP) 和数据挖掘功能提供联机分析处理。 可执行文件为 \<MSSQLPATH>\OLAP\Bin\msmdsrv.exe。  
...
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] VSS 编写器|[LOCAL SYSTEM](#Local_System)|[LOCAL SYSTEM](#Local_System)|  
 ...
 <sup>*</sup>当需要计算机外部的资源时 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ， [!INCLUDE[msCoName](../../includes/msconame-md.md)] 建议使用托管服务帐户 (MSA) ，并使用所需的最低权限进行配置。  
